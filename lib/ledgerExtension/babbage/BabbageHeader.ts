...
import {
    ...
    opCertFromCborObj,
    opCertToCborObj,
    opCertToCborObjElems,
} from "../common/operationalCert";
...
import {
    IProtocolVersion,
    protocolVersionFromCborObj,
    protocolVersionToCborObj,
} from "../common/protocolVersion";
...
export class BabbageHeader implements IBabbageHeader {
    ...
    static fromCborObj(
        ...
        const [cHdrBody, cBodySignature] = cbor.array;
