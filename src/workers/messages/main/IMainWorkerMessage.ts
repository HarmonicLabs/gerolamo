...
export interface IMainWorkerMessage<
    K extends MainMessageKind = MainMessageKind,
> {
    kind: K;
...
export type DataOfMainMessage<K extends MainMessageKind> =
    K extends MainMessageKind.PeerWorkerSetup
        ? PeerWorkerSetupData
        : K extends MainMessageKind.LedgerStateChainSelWorkerSetup
          ? LedgerStateChainSelWorkerSetupData
          : never;
