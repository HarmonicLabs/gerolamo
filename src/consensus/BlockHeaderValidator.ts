...
export class BlockHeaderValidator {
    ...
    constructor(
        ...
        this.epochNonce = Uint8Array.prototype.slice.call(
            epochNonce,
            0,
            32,
        ...
        if (
            ...
            throw new Error(
                "activeSlotCoeff numerator must be a safe integer between 0 and 100",
            );
        ...
        if (
            ...
            throw new Error(
                "activeSlotCoeff denominator must be a safe integer between numerator and 100",
            );
